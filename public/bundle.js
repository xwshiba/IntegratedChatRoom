...
function addAbilityToLogin(_ref) {
  ...
  appEl.addEventListener('submit', function (e) {
    ...
    (0,_services__WEBPACK_IMPORTED_MODULE_1__.fetchCsrfToken)().then(function (token) {
      var csrfToken = token.token;
      return (0,_services__WEBPACK_IMPORTED_MODULE_1__.fetchLogin)(csrfToken, username);
...
function addAbilityToLogout(_ref2) {
  ...
  appEl.addEventListener('click', function (e) {
    ...
    (0,_services__WEBPACK_IMPORTED_MODULE_1__.fetchCsrfToken)().then(function (token) {
      var csrfToken = token.token;
      return (0,_services__WEBPACK_IMPORTED_MODULE_1__.fetchLogout)(csrfToken);
...
function addAbilityToSendMessage(_ref3) {
  ...
  appEl.addEventListener('submit', function (e) {
    ...
    (0,_services__WEBPACK_IMPORTED_MODULE_1__.fetchCsrfToken)().then(function (token) {
      var csrfToken = token.token;
      return (0,_services__WEBPACK_IMPORTED_MODULE_1__.fetchSendMessage)(csrfToken, message);
...
;
function fetchLogin(csrfToken, username) {
  return fetchRequest('/api/v2/session', {
    method: 'POST',
    headers: {
      'content-type': 'application/json',
...
;
function fetchLogout(csrfToken) {
  return fetchRequest('/api/v2/session', {
    method: 'DELETE',
    headers: {
      'X-CSRF-Token': csrfToken
...
;
function fetchSendMessage(csrfToken, message) {
  return fetchRequest('/api/v2/chats', {
    method: 'POST',
    headers: {
      'content-type': 'application/json',
...
(0,_render__WEBPACK_IMPORTED_MODULE_4__.renderFeed)({
...
function checkForSession() {
  (0,_services__WEBPACK_IMPORTED_MODULE_3__.fetchSession)().then(function (session) {
    ...
    (0,_state__WEBPACK_IMPORTED_MODULE_2__.login)(session.username); // We do not have messages yet
    (0,_render__WEBPACK_IMPORTED_MODULE_4__.renderFeed)({
      state: _state__WEBPACK_IMPORTED_MODULE_2__["default"],
      feedEl: feedEl
    }); // Show we are logged in but don't have any messages
    (0,_render__WEBPACK_IMPORTED_MODULE_4__.renderControl)({
      state: _state__WEBPACK_IMPORTED_MODULE_2__["default"],
      controlEl: controlEl
    });
    return (0,_services__WEBPACK_IMPORTED_MODULE_3__.fetchChatData)(); // By returning this promise we can chain the original promise
  })["catch"](function (err) {
    ...
    setTimeout(_listeners__WEBPACK_IMPORTED_MODULE_5__.pollRefreshedData, 5000, {
      state: _state__WEBPACK_IMPORTED_MODULE_2__["default"],
      feedEl: feedEl,
      controlEl: controlEl
    });
